...
const lineage = [
  {
    ...
    detail: 'Великий вайшнавский ачарья, открывший место рождения Господа Чайтаньи. Написал сотни книг и песен, возродив гаудия-вайшнавизм.',
  },
  {
    name: 'Шрила Бхактисиддханта Сарасвати Прабхупад',
    years: '1874 – 1937',
    role: 'Сын и ученик Бхактивиноды',
    quote: 'Проповедуйте повсеместно — каждое место священно для преданного.',
    detail: 'Основал сеть матхов по всей Индии. Первым отправил учеников проповедовать на Запад.',
  },
  {
    ...
    detail: 'Ближайший соратник Бхактисиддханты Сарасвати. Основал SCSM в Навадвипе (Западная Бенгалия). Автор глубочайших философских трудов.',
  },
  {
    name: 'Шрила Б.С. Говинда Махарадж',
    years: '1929 – 2010',
    role: 'Преемник и второй президент SCSM',
    quote: 'Предайся — и Кришна позаботится о тебе лучше, чем ты можешь себе представить.',
    detail: 'Любимый ученик Шридхара Махараджа. Распространил SCSM на всех континентах. Воплощение смирения, юмора и глубочайшей преданности.',
  },
  {
    ...
    detail: 'Проповедует сознание Кришны на русском языке. Ведёт регулярные эфиры, лекции по Бхагавад-гите, организует паломничества.',
    current: true,
  },
]
                  ...
                  >
                    ...
                    <div className={`ml-16 sm:ml-0 sm:w-[45%] ${isRight ? 'sm:mr-auto sm:pr-10' : 'sm:ml-auto sm:pl-10'}`}>
                      <div className={`rounded-2xl p-6 border shadow-sm ${guru.current ? 'bg-saffron-50 border-saffron-200/60' : 'bg-white/70 border-gold-200/50'}`}>
                        ...
                        {guru.current && (
                          <span className="inline-block mt-3 px-3 py-1 bg-saffron-500 text-ivory-50 rounded-full text-xs font-sans">
                            Ваш Гурудев
                          </span>
                        )}
                      </div>
